...
API_ID = int(environ.get('API_ID', '30767171')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'af363a055e5c68096847d64871c758c5')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8715060976:AAGHuWfvMgPBdkvkmgGcg6BZHkZBt9Pg-CU")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '831914379').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003474248030').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003635806022'))  # Log channel id (make sure bot is admin)
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003577543017').split()] #(make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Mryog:Yogesh913232@filtet0.bzpa381.mongodb.net/?appName=Filtet0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Filtet0") # Database name (default: cluster)
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003641821557')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003641821557')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/LinkOpenNow/3")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/LinkOpenNow/3")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/LinkOpenNow/3")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "fb651ac52240c7865717bc46a105eb8a0d7246e1") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "https://api.gplinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "fb651ac52240c7865717bc46a105eb8a0d7246e1")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "nowshort.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "fb651ac52240c7865717bc46a105eb8a0d7246e1")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "nowshort.com") # Shortener website for third website

TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "30")) # Time gap for two-step verification in seconds (default: 20 minutes)
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "34"))    

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MTC_Update') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/MTC_Update') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/MTC_Update') # Update channel link for the bot
