class script(object):
        START_TXT = """<b><u>⚡️𝗦𝗬𝗦𝗧𝗘𝗠 𝗢𝗡𝗟𝗜𝗡𝗘: 𝗥𝗘𝗔𝗗𝗬 𝗧𝗢 𝗟𝗔𝗧𝗘𝗦𝗧 𝗗𝗥𝗢𝗣 ⚡️</u></b>

<b>HEY {}, {}</b>

<b>🤖 I AM <a href=https://t.me/{}>{}</a>, THE MOST POWERFUL AUTO FILTER BOT WITH PREMIUM FEATURES.</b>

<b>👇 ʜᴏᴡ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ꜰɪʟᴇꜱ:</b>
<b>1️⃣ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ꜰɪʟᴇ ʟɪɴᴋ ʏᴏᴜ ᴡᴀɴᴛ.</b>
<b>2️⃣ ᴄᴏᴍᴘʟᴇᴛᴇ ᴀ Qᴜɪᴄᴋ 1-ꜱᴛᴇᴘ ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ (0/1).</b>
<b>3️⃣ ɢᴇᴛ ʏᴏᴜʀ ꜰɪʟᴇ ɪɴꜱᴛᴀɴᴛʟʏ! ⚡️</b>

<b>💎 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ ꜰɪʟᴇꜱ ᴡɪᴛʜᴏᴜᴛ ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ, ʏᴏᴜ ᴄᴀɴ ʙᴜʏ ᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ.</b>
"""

    GSTART_TXT = """<b>⚡️𝗦𝗬𝗦𝗧𝗘𝗠 𝗢𝗡𝗟𝗜𝗡𝗘: 𝗥𝗘𝗔𝗗𝗬 𝗧𝗢 𝗟𝗔𝗧𝗘𝗦𝗧 𝗗𝗥𝗢𝗣 ⚡️</b>
...
<blockquote>😌 यह ᴍᴏᴠɪᴇ मुझे ᴍᴇʀᴇ ᴅᴀᴛᴀʙᴀꜱᴇ में नहीं मिली।</blockquote>"""
    ...
    MELCOW_ENG = """<b>👋 ʜᴇʏ {},\n\n🍁 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ\n🌟 {} \n\n🔍 ʜᴇʀᴇ ʏᴏᴜ ᴄᴀɴ ꜱᴇᴀʀᴄʜ ʏᴏᴜʀ ꜰᴀᴠᴏᴜʀɪᴛᴇ ᴍᴏᴠɪᴇꜱ ᴏʀ ꜱᴇʀɪᴇꜱ ʙʏ ᴊᴜꜱᴛ ᴛʏᴘɪɴɢ ɪᴛ'ꜱ ɴᴀᴍᴇ 🔎\n\n⚠️ ɪꜰ ʏᴏᴜ'ʀᴇ ʜᴀᴠɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʀᴇɢᴀʀᴅɪɴɢ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴏʀ ꜱᴏᴍᴇᴛʜɪɴɢ ᴇʟꜱᴇ ᴛʜᴇɴ ᴍᴇꜱꜱᴀɢᴇ ʜᴇʀᴇ 👇</b>"""
        ...
        DISCLAIMER_TXT = """<b>🛑 ᴅɪsᴄʟᴀɪᴍᴇʀ : 👇

ᴀʟʟ ᴛʜᴇ ғɪʟᴇs ɪɴ ᴛʜɪs ʙᴏᴛ ᴀʀᴇ ғʀᴇᴇʟʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴛʜᴇ ɪɴᴛᴇʀɴᴇᴛ ᴏʀ ᴘᴏsᴛᴇᴅ ʙʏ sᴏᴍᴇʙᴏᴅʏ ᴇʟsᴇ. ᴛʜɪs ʙᴏᴛ ɪs ᴏɴʟʏ ɪɴᴅᴇxɪɴɢ ғɪʟᴇs ᴡʜɪᴄʜ ᴀʀᴇ ᴀʟʀᴇᴀᴅʏ ᴜᴘʟᴏᴀᴅᴇᴅ ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ ғᴏʀ ᴇᴀsʏ sᴇᴀʀᴄʜɪɴɢ. 

ᴡᴇ ʀᴇsᴘᴇᴄᴛ ᴀʟʟ ᴄᴏᴘʏʀɪɢʜᴛ ʟᴀᴡs ᴀɴᴅ ᴡᴏʀᴋ ɪɴ ᴄᴏᴍᴘʟɪᴀɴᴄᴇ ᴡɪᴛʜ ᴅᴍᴄᴀ ᴀɴᴅ ᴇᴜᴄᴅ. ɪғ ᴀɴʏᴛʜɪɴɢ ɪs ᴀɢᴀɪɴsᴛ ʟᴀᴡ ᴏʀ ᴠɪᴏʟᴀᴛɪɴɢ ʏᴏᴜʀ ɪɴᴛᴇʟʟᴇᴄᴛᴜᴀʟ ᴘʀᴏᴘᴇʀᴛʏ, ᴘʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ ᴏᴡɴᴇʀ sᴏ ᴛʜᴀᴛ ɪᴛ ᴄᴀɴ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ ᴀsᴀᴘ.

ᴛʜᴇ ʙᴏᴛ ᴅᴏᴇs ɴᴏᴛ ᴏᴡɴ ᴀɴʏ ᴏғ ᴛʜᴇsᴇ ᴄᴏɴᴛᴇɴᴛs. ɪᴛ ɪs ғᴏʀʙɪᴅᴅᴇɴ ᴛᴏ ᴜsᴇ ᴄᴏɴᴛᴇɴᴛ ᴡɪᴛʜᴏᴜᴛ ᴘᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴛʜᴇ ʟᴇɢᴀʟ ᴏᴡɴᴇʀ. ᴜsᴇ ᴛʜɪs sᴇʀᴠɪᴄᴇ ᴀᴛ ʏᴏᴜʀ ᴏᴡɴ ʀɪsᴋ. 🙏</b>"""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/MTC_Update'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/MTC_Update'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</b>"""
        ...
        SOURCE_TXT = """<b>SOURCE DETAILS : 👇 </b>

This is a Custom-Designed and highly modified project. A lot of hard work and time has gone into developing and setting up this bot. 
Copying or selling this setup is strictly prohibited. 🚫

🧑‍💻 DEVELOPED BY ➡️ : <a href='https://t.me/MTC_Update'>Mr Yog</a> """
...
📌 ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰʏ! ᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴏɴ
♻️ ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴠᴇʀɪꜰʏ ♻️ ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇꜱꜱ ᴛᴏ ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇ.
...
ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇ.</i></b>"""
...
ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇ ʙᴇʟᴏᴡ.</i></b>"""
